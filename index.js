...
function findUnique(arr) {
    ...
    // Первый проход: считаем количество каждого элемента, то есть в качестве ключей у нас будут числа массива, а значения количества их вхождений в массив
    for (let num of arr) {
        count[num] = (count[num] || 0) + 1;
    }

    // Второй проход: возвращаем элементы, которые встречаются ровно один раз
